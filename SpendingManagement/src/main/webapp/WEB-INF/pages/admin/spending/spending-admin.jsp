        ...
        <c:forEach items="${personalTransaction}" var="p">
            <tr id="personalTransaction${p.id}">
                ...
                <td>
                    ...
                    <a href="javascript:;" onclick="adminSpendingView('${endpointview}')" class="btn-spending js-view-spending" style="color: blue; margin-right: 5px;"><i class="fas fa-eye"></i></a>
                    <a href="<c:url value="/admin/spending-admin/${p.id}" />" class="btn-spending" style="color: #00bbb3; margin-right: 5px;"><i class="fas fa-pen"></i></a>
        ...
        <div class="modal-view-body">
            <section class="section about-section gray-bg" id="about">
                <div class="container m-0">
                    <div class="row flex-row-reverse"  id="js-modal-view-spending">
